...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { canvas_id: @block.canvas_id, takeaway: @block.takeaway, title: @block.title }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { canvas_id: @block.canvas_id, takeaway: @block.takeaway, title: @block.title }
    assert_redirected_to block_path(assigns(:block))
  end
